...
var feed, add, fedTime, foodObj, lastfed, lastFed; 
var gameState = "start", changeGS, readGS;
...
function preload()
{
  ...
  bedroomimg = loadImage("images2/bedroom.png")
  gardenimg = loadImage("images2/garden.png")
  washroomimg = loadImage("images2/washroom.png")
  livingroomimg = loadImage("images2/livingroom.png")
}
...
function draw() { 
  ...
  if(currentHour==lastfed+5) {
    background(washroomimg)
  }
  if(currentHour==lastfed+7) {
